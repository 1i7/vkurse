    ...
    case 5:
		...
		else
		{
		    if(request.getParameter("confirm")==null)
			{
				...
				%> 
				   <a href="admin_add_edit.jsp?action=5&subaction=<%= request.getParameter("subaction") %>&confirm=1&id=<%= request.getParameter("id") %>">Да</a></br>
	...
	case 7:
	    ...
	    if(request.getParameter("confirm")==null)
		{
			...
			case 1:
				...
				r = rt.get(id);
				%><form action="admin_add_edit.jsp" method="get">
				Аудитория:<input type="text" name="name" <%= r.getName() %>/>
				<input type="hidden" name="action" value="7">  
